...
if(isset($_POST['Submit'])) {	
	...
	if(empty($nome_completo) || empty($cargo_id) || empty($data_admissao) || empty($salario)) {
		...
		$result = mysqli_query($mysqli, "INSERT INTO funcionarios (nome_completo, cargo_id, data_admissao, salario, cargo_ativo) VALUES ('$nome_completo','$cargo_id','$data_admissao','$salario','$cargo_ativo')");
		...
		if($result) {
			...
			echo "<a class='login-button' href='funcTable.php'>Ver Resultado</a>";
			echo "</div>";
		} else {
